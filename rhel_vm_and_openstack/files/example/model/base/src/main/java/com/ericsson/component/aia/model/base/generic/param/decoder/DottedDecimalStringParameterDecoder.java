...
public class DottedDecimalStringParameterDecoder extends GenericParameterDecoder {

    /**
     * @param eventParameter
     */
    public DottedDecimalStringParameterDecoder(final EventParameter eventParameter) {
        super(eventParameter);
    }

    @Override
    protected Object decode(final byte[] data, final int offset) {
        return dataConverterHelper.getByteArrayDottedDecimalString(data, offset, eventParameter.getNumberOfBytes());
    }
