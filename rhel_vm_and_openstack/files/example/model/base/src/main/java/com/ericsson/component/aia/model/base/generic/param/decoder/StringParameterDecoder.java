...
public class StringParameterDecoder extends GenericParameterDecoder {

    /**
     * @param eventParameter
     */
    public StringParameterDecoder(final EventParameter eventParameter) {
        super(eventParameter);
    }

    @Override
    protected Object decode(final byte[] data, final int offset) {
        return dataConverterHelper.getString(data, offset, eventParameter.getNumberOfBytes());
    }
