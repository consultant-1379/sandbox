(function(window, document, $, Modernizr, undefined) {
  ...
  Application.prototype.device = {
    'large': function() {
      return !Modernizr.mq('only all') || Modernizr.mq('only screen and (min-width: 1024px)');//1140
    },
    'medium': function() {
      return (!Application.prototype.device.large()) && Modernizr.mq('only screen and (min-width: 900px)');//768
    },
    'small': function() {
